...
<html>
<head>
  <title>Services | EAD ONLINE CLASSES</title>
...
<?php include("common/header.php");?>
    ...
    <!-- ======= Doctors Section ======= -->
    <br> <br><br> <br>
    <section id="doctors" class="doctors" style="margin: 13px 0px;">
      <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="member d-flex align-items-start">
                          ...
                          <div class="member-info">
                            <h4>Raman Sir </h4>
                            <span>MD/CEO OF EAD ONLINE CLASSES</span>
                            <p>Engineering Academy is my Dream</p>
                            <div class="social">
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-toggle="tab" href="#tab-1">Electrical Department</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-2">Electronics Department</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-3">Civil Department</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-4">Mechnical Department</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab-5">Non-Technical Department</a>
              </li>
            </ul>
          </div>
